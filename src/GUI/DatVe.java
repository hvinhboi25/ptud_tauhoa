...
public class DatVe extends JFrame {
	...
	public DatVe() {
		...
		JLabel lblNewLabel = new JLabel("Ga đến: ");
		...
		JLabel lblNewLabel_3 = new JLabel("Ngày về:");
		...
		btnTim.setIcon(new ImageIcon(DatVe.class.getResource("/img/9004811_zoom_magnifier_find_search.png")));
		...
		btnHuy.setIcon(new ImageIcon(DatVe.class.getResource("/img/9004828_cancel_remove_delete_cross.png")));
		...
		JLabel lblNewLabel_6 = new JLabel("THÔNG TIN HÀNH TRÌNH");
		...
		btnToaSo10.setIcon(new ImageIcon(DatVe.class.getResource("/img/trainCar.png")));
		...
		btnToaSo9.setIcon(new ImageIcon(DatVe.class.getResource("/img/trainCar.png")));
		...
		btnToaSo8.setIcon(new ImageIcon(DatVe.class.getResource("/img/trainCar.png")));
		...
		btnToaSo7.setIcon(new ImageIcon(DatVe.class.getResource("/img/trainCar.png")));
		...
		btnToaSo6.setIcon(new ImageIcon(DatVe.class.getResource("/img/trainCar.png")));
		...
		btnToaSo5.setIcon(new ImageIcon(DatVe.class.getResource("/img/trainCar.png")));
		...
		btnToaSo4.setIcon(new ImageIcon(DatVe.class.getResource("/img/trainCar.png")));
		...
		btnToaSo3.setIcon(new ImageIcon(DatVe.class.getResource("/img/trainCar.png")));
		...
		btnToaSo2.setIcon(new ImageIcon(DatVe.class.getResource("/img/trainCar.png")));
		...
		btnToaSo1.setIcon(new ImageIcon(DatVe.class.getResource("/img/trainCar.png")));
		...
		btnDauTau.setIcon(new ImageIcon(DatVe.class.getResource("/img/train2.png")));
		...
		btnTau1.setIcon(new ImageIcon(DatVe.class.getResource("/img/tau.png")));
		...
		btnTau2.setIcon(new ImageIcon(DatVe.class.getResource("/img/tau.png")));
		...
		JLabel lblNewLabel_4 = new JLabel("Đặt vé tàu");
		...
		btnTiepTuc.setIcon(new ImageIcon(DatVe.class.getResource("/img/9004839_next_right_direction_arrow.png")));
